...
- `git clone https://github.com/UniversalPropositions/UP_French-Sequoia.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_French-Sequoia>/ --input_up=<up_path_to_UP_French-Sequoia>/ --output=<path_to_UD+UP_French-Sequoia>/`
